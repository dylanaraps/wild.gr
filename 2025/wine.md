...
color="#ffbf00"
bbg="#fff" use head
bg=#fff nav_arrow_dark=0 wave_img=hdr-wine.jpg use nav
---
...
<div class=col-lg>
--- images="wine-w.jpg wine-front.jpg wine-back.jpg" width=1 height=1 id=carousel use carousel
</div>
</div>
</section>
...
--- use footer
--- sel="nav,section,.carousel,figure,.wave img" shift=2rem use fade
